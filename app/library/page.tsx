...
const AccessibleLibrary: React.FC = () => {
  ...
  const categories = [
    ...
    { title: 'Education', icon: 'book-reader', desc: 'This category encompasses services related to learning, skill development, and academic advancement.', img: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=2940&auto=format&fit=crop' },
    ...
    { title: 'Legal Assistance', icon: 'gavel', desc: 'This category includes services that provide legal advice, representation, and information.', img: 'https://images.unsplash.com/photo-1589391886085-8b6b0ac72a1a?q=80&w=2942&auto=format&fit=crop' },
    { title: 'Assistive Technology', icon: 'laptop', desc: 'This category includes services and resources related to devices, software, and equipment that help individuals with disabilities perform daily activities and increase independence.', img: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?q=80&w=2786&auto=format&fit=crop' },
